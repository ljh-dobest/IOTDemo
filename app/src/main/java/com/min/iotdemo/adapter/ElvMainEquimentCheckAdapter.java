...
public class ElvMainEquimentCheckAdapter extends BaseExpandableListAdapter {
    private List<Equiment> dataset = new ArrayList<>();
    private Context mContext;
    private LayoutInflater inflater;
    public ElvMainEquimentCheckAdapter(List<Equiment> dataset, Context context) {
    ...
    public View getChildView(int parentPos, int childPos, boolean b, View view, ViewGroup viewGroup) {
        if (view == null) {}
            view = inflater.inflate(R.layout.elv_check_item, null);
        final Equiment equiment=dataset.get(childPos);
        CheckBox checkBox = (CheckBox) view.findViewById(R.id.cb_check_item);
